...
#dnf unlock
alias unlock="sudo rm /var/cache/dnf/lock"
...
alias ldnf="bat /var/log/dnf5.log"
...
alias cd..='cd ..'
alias pdw='pwd'
alias udpate='sudo dnf upgrade --refresh'
alias upate='sudo dnf upgrade --refresh'
alias updte='sudo dnf upgrade --refresh'
alias updqte='sudo dnf upgrade --refresh'
