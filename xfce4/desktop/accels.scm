...
(gtk_accel_path "<Actions>/XfdesktopFileIconManager/open-with-other" "<Primary><Shift>o")
...
(gtk_accel_path "<Actions>/XfceDesktop/next-background" "<Shift>greater")
...
(gtk_accel_path "<Actions>/XfdesktopFileIconManager/create-document" "<Primary>n")
